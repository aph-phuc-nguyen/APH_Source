    ...
    public partial class MainForm : MaterialForm
    {
        ...
        private void GetDepartmentByUser() {
            ...
            if (Convert.ToBoolean(JsonConvert.DeserializeObject<Dictionary<string, object>>(ret)["IsSuccess"]))
            {
                ...
                //tier 2 - section
                type = (int)Parameters.QueryDeptType.Section;
                txtDepartment.Text = dtJson.Rows[0]["UDF07"].ToString();
                this.userPlant = dtJson.Rows[0]["UDF05"].ToString();
                this.userSection = dtJson.Rows[0]["UDF07"].ToString();
                this.dept = dtJson.Rows[0]["UDF07"].ToString();
            }
            else
            {
        ...
        private void SetBG()
        {
            ...
            lblTier2Header.ForeColor = textColor;
        ...
        private void InitUI()
        {
            ...
            if (height < 800)
            {
                lblTier2Header.Dock = DockStyle.Left;
            }
            ...
            lblTier2Header.Font = new Font(Parameters.headerFont, height/40f, FontStyle.Bold, GraphicsUnit.Point, 134);
        ...
        {
            KaizenActionForm frm = new KaizenActionForm(date.Text, dept, type, userPlant, userSection);
            frm.Show();
        }
        private void btnMA_Click(object sender, EventArgs e)
        {
            MaturityAssessmentForm frm = new MaturityAssessmentForm(dept, type, userPlant, userSection);
            frm.Show();
        }
        ...
        private void GetQualityData()
        {
            ...
            else if (type == (int)Parameters.QueryDeptType.Line)
            {
                p.Add("vDept", dept);
                ret = SJeMES_Framework.WebAPI.WebAPIHelper.Post(Program.client.APIURL, "KZ_QCMAPI",
                "KZ_QCMAPI.Controllers.TierMeetingServer", "Tier1_WeekQuery",
                Program.client.UserToken, JsonConvert.SerializeObject(p));
            }
