...
namespace F_TMS_TierMeeting3_Main
{
    public partial class KaizenActionForm : MaterialForm
    {
        ...
        public KaizenActionForm(string date, string dept, int type, string userPlant)
        {
            //this.date = date;
        ...
        {
            SelectDepartmentForm frm = new SelectDepartmentForm((int)Parameters.QueryDeptType.Line, userPlant);
