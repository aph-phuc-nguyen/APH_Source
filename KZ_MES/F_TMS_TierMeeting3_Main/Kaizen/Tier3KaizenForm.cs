...
{
    public partial class Tier3KaizenForm : MaterialForm
    {
        ...
        public Tier3KaizenForm(string date, string plant)
        {
            this.date = date;
            this.plant = plant;
            InitializeComponent();
        ...
        {
            int index = this.gridData.CurrentCell.ColumnIndex;
            string section = this.gridData.Columns[index].HeaderText;
            Tier2KaizenForm frm = new Tier2KaizenForm(date, plant, section);
            frm.Show();
        }
