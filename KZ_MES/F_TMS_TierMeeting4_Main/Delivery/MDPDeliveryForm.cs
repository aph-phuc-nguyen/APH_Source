...
namespace TierMeeting
{
    public partial class MDPDeliveryForm : MaterialForm
    {
        ...
        private void GetData() {
            ...
            ExcelApp.Range rangeTitle = excelSheet.get_Range("D13:P13", Missing.Value);
            if (rangeTitle != null) {
            ...
            ExcelApp.Range range = excelSheet.get_Range("D14:P36", Missing.Value);
            if (range != null)
            {
                foreach (ExcelApp.Range r in range)
                {
                    ...
                    if (tmpCol == 4)
                        gridData.Rows.Add();
                    gridData.Rows[tmpRow - 14].Cells[tmpCol - 4].Value = str;
                }
            }
