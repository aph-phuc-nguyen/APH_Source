...
namespace F_MMS_TrackIn_List
{
    public partial class F_MMS_TrackIn_ListForm : MaterialForm
    {
        DataTable ErrorDataTable = new DataTable();
        DataTable ScanDataTable = new DataTable();
        Timer timer1 = new Timer();

        public F_MMS_TrackIn_ListForm()
        {
            InitializeComponent();
        }
        ...
        private  void SaveQrCode(string ord_id,string  se_id,string se_seq,string size_no,int qty,string size_seq,string art_no,string mate_tieno, string tieno,string to_company)
        {
            try
            {
                ...
                string ret = SJeMES_Framework.WebAPI.WebAPIHelper.Post(Program.Client.APIURL, "KZ_MMSAPI", "KZ_MMSAPI.Controllers.MMS_TrackIn_ListServer", "Save", Program.Client.UserToken, Newtonsoft.Json.JsonConvert.SerializeObject(p));
        ...
        private void F_MMS_TrackIn_ListForm_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                string ret = SJeMES_Framework.WebAPI.WebAPIHelper.Post(Program.Client.APIURL, "KZ_MMSAPI", "KZ_MMSAPI.Controllers.MMS_TrackIn_ListServer", "QueryWareHouse", Program.Client.UserToken, string.Empty);
                if (Convert.ToBoolean(Newtonsoft.Json.JsonConvert.DeserializeObject<Dictionary<string, object>>(ret)["IsSuccess"]))
                {
        ...
        private void btnQuery_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string ret = SJeMES_Framework.WebAPI.WebAPIHelper.Post(Program.Client.APIURL, "KZ_MMSAPI", "KZ_MMSAPI.Controllers.MMS_TrackIn_ListServer", "QueryScanInfo", Program.Client.UserToken, Newtonsoft.Json.JsonConvert.SerializeObject(p));
                if (Convert.ToBoolean(Newtonsoft.Json.JsonConvert.DeserializeObject<Dictionary<string, object>>(ret)["IsSuccess"]))
                {
                    string json = Newtonsoft.Json.JsonConvert.DeserializeObject<Dictionary<string, object>>(ret)["RetData"].ToString();
                    DataTable dtJson = SJeMES_Framework.Common.JsonHelper.GetDataTableByJson(json);
        ...
        private void textBoxEx19_MouseLeave(object sender, EventArgs e)
        {
            try
            {
                if (!string.IsNullOrEmpty(textBoxEx19.Text.Trim()))
                {
                    ...
                    string ret = SJeMES_Framework.WebAPI.WebAPIHelper.Post(Program.Client.APIURL, "KZ_MMSAPI", "KZ_MMSAPI.Controllers.MMS_TrackIn_ListServer", "QuerySeInfo", Program.Client.UserToken, Newtonsoft.Json.JsonConvert.SerializeObject(p));
                    if (Convert.ToBoolean(Newtonsoft.Json.JsonConvert.DeserializeObject<Dictionary<string, object>>(ret)["IsSuccess"]))
                    {
        ...
        private void textBoxEx16_MouseLeave(object sender, EventArgs e)
        {
            try
            {
                if (!string.IsNullOrEmpty(textBoxEx16.Text.Trim())&& string.IsNullOrEmpty(textBoxEx19.Text.Trim()))
                {
                    ...
                    string ret = SJeMES_Framework.WebAPI.WebAPIHelper.Post(Program.Client.APIURL, "KZ_MMSAPI", "KZ_MMSAPI.Controllers.MMS_TrackIn_ListServer", "QuerySizeInfo", Program.Client.UserToken, Newtonsoft.Json.JsonConvert.SerializeObject(p));
                    if (Convert.ToBoolean(Newtonsoft.Json.JsonConvert.DeserializeObject<Dictionary<string, object>>(ret)["IsSuccess"]))
                    {
        ...
        private void btnDetailQuery_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string ret = SJeMES_Framework.WebAPI.WebAPIHelper.Post(Program.Client.APIURL, "KZ_MMSAPI", "KZ_MMSAPI.Controllers.MMS_TrackIn_ListServer", "QueryDetailScanInfo", Program.Client.UserToken, Newtonsoft.Json.JsonConvert.SerializeObject(p));
                if (Convert.ToBoolean(Newtonsoft.Json.JsonConvert.DeserializeObject<Dictionary<string, object>>(ret)["IsSuccess"]))
                {
                    string json = Newtonsoft.Json.JsonConvert.DeserializeObject<Dictionary<string, object>>(ret)["RetData"].ToString();
                    DataTable dtJson = SJeMES_Framework.Common.JsonHelper.GetDataTableByJson(json);
